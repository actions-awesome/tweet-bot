...
Object.defineProperty(Credentials$1, "__esModule", { value: true });
const oauth_1_0a_1 = __importDefault$1(oauth1_0a.exports);
const crypto_1 = __importDefault$1(require$$1__default$1["default"]);
const node_fetch_1 = __importDefault$1(require$$1);
const TwitterError_1$1 = __importDefault$1(TwitterError.exports);
...
async function createBearerToken({ consumer_key, consumer_secret }) {
    ...
    if (body.errors) {
        ...
        throw new TwitterError_1$1.default(`${body.title}: ${error.message}`, body.type, body.detail);
    }
    if (body.token_type != 'bearer') {
        throw new TwitterError_1$1.default('Unexpected reply from Twitter upon obtaining bearer token', undefined, `Expected "bearer" but found ${body.token_type}`);
    }
...
Credentials$1.default = Credentials;
...
var Decoder = require$$1__default$2["default"].StringDecoder;
...
Object.defineProperty(TwitterStream$1, "__esModule", { value: true });
const split_1 = __importDefault(split_1$1);
const TwitterError_1 = __importDefault(TwitterError.exports);
var State;
(function (State) {
...
TwitterStream$1.default = TwitterStream;
...
Object.defineProperty(exports, "__esModule", { value: true });
const abort_controller_1 = __importDefault(require$$0);
const node_fetch_1 = __importDefault(require$$1);
const url_1 = Url__default["default"];
const Credentials_1 = __importDefault(Credentials$1);
const TwitterError_js_1 = __importDefault(TwitterError.exports);
const TwitterStream_1 = __importDefault(TwitterStream$1);
...
}(twitter, twitter.exports));

var Twitter = /*@__PURE__*/getDefaultExportFromCjs(twitter.exports);
...
function main() {
    return __awaiter$1(this, void 0, void 0, function* () {
        const access_token_key = core.getInput(ACCESS_TOKEN_KEY);
        ...
        const tweetToSend = core.getInput(TWEET);
        ...
        try {
            yield twitter.post('tweets', {
                text: tweetToSend,
            });
            core.info(`Tweet sent successfully with content: ${tweetToSend}`);
        }
        catch (e) {
            core.setFailed(e);
        }
